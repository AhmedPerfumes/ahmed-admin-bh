                                                                                                                ...
                                                                                                                foreach ($order_products as $key => $value) {
                                                                                                                    if($value->discount_percent != 0) {
                                                                                                                        ...
                                                                                                                        $body .= '<tr>
                                                                                                                            ...
                                                                                                                            <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x062F;&#x002E;&#x0628;'.number_format(((float) ($value->price * 1.10) - ((($value->price * 1.10) / 100) * $value->sale_price) * $value->qty), 3, '.', '').'</div>
                                                                                                                            </td>
                                                                                                                        </tr>';
                                                                                                                      } else {
                                                                                                                        $body .= '<tr>
